...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = '1_attacks/2.data';
      var REMOTE_PACKAGE_BASE = '2.data';
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_1_attacks/2.data');

      };
      Module['addRunDependency']('datafile_1_attacks/2.data');
   ...
   loadPackage({"files": [{"start": 0, "audio": 0, "end": 585984, "filename": "/DemoKey_table.bin"}], "remote_package_size": 585984, "package_uuid": "83e6bdf2-c7cf-4e0a-8b45-d187aacb5609"});
