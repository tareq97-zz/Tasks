...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = '1_attacks/3_2.data';
      var REMOTE_PACKAGE_BASE = '3_2.data';
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_1_attacks/3_2.data');

      };
      Module['addRunDependency']('datafile_1_attacks/3_2.data');
   ...
   loadPackage({"files": [{"start": 0, "audio": 0, "end": 349184, "filename": "/wbt_noenc"}], "remote_package_size": 349184, "package_uuid": "39dd4901-0580-435f-9fb8-fd6f05411dd9"});
