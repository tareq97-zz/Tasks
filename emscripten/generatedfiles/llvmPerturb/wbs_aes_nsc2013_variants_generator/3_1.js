...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = '1_attacks/3_1.data';
      var REMOTE_PACKAGE_BASE = '3_1.data';
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_1_attacks/3_1.data');

      };
      Module['addRunDependency']('datafile_1_attacks/3_1.data');
   ...
   loadPackage({"files": [{"start": 0, "audio": 0, "end": 349184, "filename": "/wbt_noenc"}], "remote_package_size": 349184, "package_uuid": "d7f00c67-decf-43aa-9aef-a33d7ace1c51"});
