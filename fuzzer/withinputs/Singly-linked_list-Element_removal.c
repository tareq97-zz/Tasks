...
list EMSCRIPTEN_KEEPALIVE addToList(list a,int num){
...
list EMSCRIPTEN_KEEPALIVE deleteFromList(list a,int pos){
...
void EMSCRIPTEN_KEEPALIVE printList(list a){
	list temp = a;
...
int main(int argC,char* argV[], int postionto_remove)
{
	list a = NULL;
	int i;
